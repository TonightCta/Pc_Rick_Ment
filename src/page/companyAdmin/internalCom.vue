...
<template lang="html">
  <div class="internalEng">
    ...
    <div class="engCon">
      <p class="addEng">
        <el-button type="primary" icon="el-icon-plus" size="medium" @click="pushEng()" @keyup.enter.native="abc($event)">添加企业</el-button>
      ...
      <div class="internalEng_title">
        <el-row>
          ...
          <el-col :span="3"><div class="listTitle">企业名称</div></el-col>
          <el-col :span="2"><div class="listTitle">联系人</div></el-col>
      ...
      <div class="internalEng_con" v-loading="engLoad">
        <el-row class="el_con publicHover" v-for="(eng,index) in engList" :key="'el'+index">
          ...
          <el-col :span="3" v-if="eng.phone!=null&&eng.phone!=''"><div class="listCon">{{eng.phone}}</div></el-col>
          <el-col :span="3" v-else><div class="listCon">-</div></el-col>
          <el-col :span="3"><div class="listCon">{{eng.operatorName}}</div></el-col>
          <el-col :span="4" v-if="eng.email!=null&&!eng.emailToop"><div class="listCon">{{eng.email}}</div></el-col>
          <el-tooltip class="item" effect="dark" v-if="eng.email!=null&&eng.emailToop" :content="eng.email" placement="bottom">
            <el-col :span="4" ><div class="listCon" style="cursor:pointer;">{{eng.email.substring(0,12)}}...</div></el-col>
          </el-tooltip>
        ...
        <el-dialog
          ...
          <div class="addEngBox">
            ...
            <ul class="add_con">
              ...
              <li><el-input v-model="addEngMes.cusName" placeholder="请输入联系人姓名"/></li>
              <li><el-input v-model="addEngMes.phone" placeholder="请输入手机号码"/></li>
              <li><el-input v-model="addEngMes.peopleNum" placeholder="请输入企业技术人员人数"/></li>
        ...
        <el-dialog
          ...
          <div class="addEngBox">
            ...
            <ul class="add_con">
              ...
              <li><el-input v-model="editEngMes.linkName" placeholder="请输入联系人姓名"/></li>
              <li><el-input v-model="editEngMes.phone" placeholder="请输入手机号码"/></li>
              <li><el-input v-model="editEngMes.peopleNumber" placeholder="请输入手机号码"/></li>
              ...
              <li style="margin-top:30px;padding-bottom:20px;">
                ...
                <el-input
                  ...
                  :autosize="{ minRows: 6, maxRows: 15}"
                  placeholder="请输入评定说明"
                  v-model="editEngMes.serviceScope">
                </el-input>
              </li>
              <li style="margin-top:30px;padding-bottom:20px;">
                <span>评定说明:</span>
        ...
        <el-dialog
         ...
         append-to-body>
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">公司名称:</span>
             <span style="width:75%;text-align:left;box-sizing:border-box;padding-left:20px;">{{engMes.name}}</span>
           </p>

           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">联系人:</span>
             <span style="width:75%;text-align:left;box-sizing:border-box;padding-left:20px;">{{engMes.linkName}}</span>
           </p>
           ...
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">企业技术人员人数:</span>
             <span style="width:75%;text-align:left;box-sizing:border-box;padding-left:20px;">{{engMes.peopleNumber}}</span>
           </p>
           ...
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">企业认证:</span>
           ...
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">企业评估:</span>
             <span style="width:75%;text-align:left;box-sizing:border-box;padding-left:20px;display:flex;flex-wrap:wrap;">
           ...
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
             <span style="width:25%;text-align:right;">服务领域:</span>
             <span style="width:75%;text-align:left;box-sizing:border-box;padding-left:20px;">{{engMes.serviceScope}}</span>
           </p>
           <p style="font-size:16px;line-height:40px;width:100%;display:flex;">
  ...
  methods:{
    ...
    subNewEng(){//提交新增工程师
      ...
      if(_vm.addEngMes.name==null||_vm.addEngMes.name==''){
        _vm.$message.error('请输入企业名称')
      }else if(_vm.addEngMes.cusName==null||_vm.addEngMes.cusName==''){
        _vm.$message.error('请输入联系人姓名')
      ...
      }else if(_vm.addEngMes.peopleNum==null||_vm.addEngMes.peopleNum==''){
        _vm.$message.error('请输入企业技术人员人数')
      }else if(_vm.addEngMes.email==null||_vm.addEngMes.email==''){
        _vm.$message.error('请输入企业邮箱')
        ...
        formdata.append('peopleNumber',_vm.addEngMes.peopleNum);
        formdata.append('linkName',_vm.addEngMes.cusName);
        if(_vm.skillText!=null&&_vm.skillText!=''){
          formdata.append('remark',_vm.skillText)
        };
        if(_vm.serviceText!=null&&_vm.serviceText!=''){
          formdata.append('serviceScope',_vm.serviceText)
        };
        formdata.append('isOfficial',false);
    ...
    turnEditEng(){//上传修改工程师
      ...
      if(vm.editEngMes.name===''||vm.editEngMes.name==null){
        vm.$message.error('请输入企业名称')
      }else if(vm.editEngMes.linkName==''||vm.editEngMes.linkName==null){
        vm.$message.error('请输入联系人名称')
      }else if(vm.editEngMes.phone==''||vm.editEngMes.phone==null){
        vm.$message.error('请输入手机号')
      }else if(vm.editEngMes.peopleNumber==''||vm.editEngMes.peopleNumber==null){
        vm.$message.error('请输入企业技术人员人数')
        ...
        formdata.append('peopleNumber',vm.editEngMes.peopleNumber);
        formdata.append('linkName',vm.editEngMes.linkName);
        formdata.append('isOfficial',false);
        formdata.append('isManager',false);
        formdata.append('isCompany',true);
        vm.cityID.forEach((e)=>{
        ...
        if(vm.editEngMes.remark!=null&&vm.editEngMes.remark!=''){
          formdata.append('remark',vm.editEngMes.remark)
        };
        if(vm.editEngMes.serviceScope!=null&&vm.editEngMes.serviceScope!=''){
